...
const languageIcons = {
  ...
  csh: "https://cdn.jsdelivr.net/gh/devicons/devicon@latest/icons/csharp/csharp-original.svg",
...
const webDevelopmentIcons = {
  ...
  tailwindcss: "https://devicon-website.vercel.app/api/tailwindcss/original-wordmark.svg",
